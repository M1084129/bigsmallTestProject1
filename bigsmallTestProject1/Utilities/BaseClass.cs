...
namespace FinalAssessment.Utilities
{
    [Binding]
    class BaseClass
    {
        ...
        {
            var htmlReport = new ExtentHtmlReporter(@"C:\Users\mindtreefeb65\source\repos\FinalAssessment\FinalAssessment");
            ...
            Log.Logger = new LoggerConfiguration()
                         ...
                         .File(@"C:\Users\mindtreefeb65\source\repos\FinalAssessment\FinalAssessmen\Logs", outputTemplate: "{TimeSpamp:yyyy-MM-dd HH:mm:ss.fff} | {Level:u3} | {Message} {NewLine}", rollingInterval: RollingInterval.Day)
                         .CreateLogger();
